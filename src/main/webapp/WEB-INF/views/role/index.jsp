        ...
        <div class="container-fluid">
            <div class="row bg-title">
                ...
                <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
                    <a href="<%= contextPath + UrlConstant.URL_ROLE_ADD %>" class="btn btn-sm btn-success">Thêm
                        mới</a>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                        ...
                        <div class="table-responsive">
                            <table class="table" id="example">
                                ...
                                <tr>
                                    ...
                                    <td><a
                                            href="<%=contextPath + UrlConstant.URL_ROLE_EDIT%>?id=<%=role.getId()%>"
                                            class="btn btn-sm btn-primary">Sửa</a> <a
                                            href="<%=contextPath + UrlConstant.URL_ROLE_DELETE%>?id=<%=role.getId()%>"
